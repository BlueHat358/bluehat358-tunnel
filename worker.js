...
const serviceName = "bluehat358-tunnel"; // Ganti dengan nama workers kalian
...
const PROXY_HEALTH_CHECK_API =
  "https://p01--boiling-frame--kw6dd7bjv2nr.code.run/check";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle(
      "Welcome to <span class='text-blue-500 font-semibold'>BlueHat358</span>"
    );
